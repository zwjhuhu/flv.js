...
class TMRangeLoader extends BaseLoader {
    ...
    _onReadyStateChange(e) {
        ...
        if (xhr.readyState === 2) { // HEADERS_RECEIVED
            if (xhr.finalUrl != undefined) { // if the browser support this property
                let redirectedURL = this._seekHandler.removeURLParameters(xhr.finalUrl);
            ...
            if ((xhr.status >= 200 && xhr.status <= 299)) {
                ...
                if (this._onError) {
                    ...
                    throw new RuntimeException('TMRangeLoader: Http code invalid, ' + xhr.status + ' ' + xhr.statusText);
                }
            }
